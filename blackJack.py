...
def make_bet():
    ...
    global bet
    bet = 0
    print("What amount of chips would you like to bet? (Enter a whole Integer)")
    ...
    while bet == 0:
        ...
        try:
            ...
            if 1 <= bet_comp <= chip_pool:
                ...
                print("Invalid bet, you only have", chip_pool, "chips remaining")
...
def game_step():
    ...
    print("\nDealer Hand is:", dealer_hand.draw(hidden=True))
...
def intro():
    ...
    statement = '''Welcome to BlackJack! Get as close to 21 as you can without going over! Dealer hits until they reach 17. Aces count as 1 or 11. Card output goes a letter followed by a number or face notation.'''
    print(statement)
